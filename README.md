...
Never commit `.env` files or service account JSON files. Create a `.env` in each project folder:

```env
APIFY_TOKEN=your_apify_token_here
GOOGLE_CREDS=path/to/service-account.json
```
...
Private — All rights reserved © kbizsoft